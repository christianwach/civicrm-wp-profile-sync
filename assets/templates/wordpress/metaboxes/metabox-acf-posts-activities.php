	...
	<?php if ( ! empty( $activity_post_types ) ) : ?>
		<table class="form-table">
			...
			<?php foreach ( $activity_post_types as $activity_post_type => $label ) : ?>
				...
				<tr valign="top">
					<td colspan="2" class="progress-bar progress-bar-hidden"><div id="progress-bar-cwps_acf_post_to_activity_<?php echo esc_attr( $activity_post_type ); ?>"><div class="progress-label"></div></div></td>
				</tr>
