...
<div class="cwps_acf_wrapper <?php echo $prefix; ?>">
	...
	<p><?php _e( 'Select which Participants you want to sync to their corresponding WordPress Post Types.', 'civicrm-wp-profile-sync' ); ?></p>
	...
	<?php else : ?>
		...
		<div class="notice notice-warning inline" style="background-color: #f7f7f7;">
			<p><?php _e( 'No synced Participant Roles found.', 'civicrm-wp-profile-sync' ); ?></p>
		</div>
