...
<div class="cwps_acf_wrapper <?php echo esc_attr( $prefix ); ?>">
	...
	<p><?php esc_html_e( 'Select which Contact Types you want to sync to their corresponding WordPress Post Types.', 'civicrm-wp-profile-sync' ); ?></p>
	...
	<?php if ( ! empty( $contact_types ) ) : ?>
		<table class="form-table">
			...
			<?php foreach ( $contact_types as $contact_type_id => $label ) : ?>
				...
				<tr valign="top">
					<td colspan="2" class="progress-bar progress-bar-hidden"><div id="progress-bar-cwps_acf_contact_to_post_<?php echo esc_attr( $contact_type_id ); ?>"><div class="progress-label"></div></div></td>
				</tr>
	...
	<?php else : ?>
		...
		<div class="notice notice-warning inline" style="background-color: #f7f7f7;">
			<p><?php esc_html_e( 'No synced Contact Types found.', 'civicrm-wp-profile-sync' ); ?></p>
		</div>
