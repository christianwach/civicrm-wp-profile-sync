...
<div class="cwps_acf_wrapper <?php echo $prefix; ?>">
	...
	<p><?php _e( 'Select which CiviCRM Groups you want to sync to their corresponding WordPress Terms.', 'civicrm-wp-profile-sync' ); ?></p>
	...
	<?php if ( ! empty( $groups ) ) : ?>
		<table class="form-table">
			...
			<?php foreach ( $groups as $group_id => $label ) : ?>
				...
				<tr valign="top">
					<td colspan="2" class="progress-bar progress-bar-hidden"><div id="progress-bar-cwps_acf_group_to_term_<?php echo $group_id; ?>"><div class="progress-label"></div></div></td>
				</tr>
	...
	<?php else : ?>
		...
		<div class="notice notice-warning inline" style="background-color: #f7f7f7;">
			<p><?php _e( 'No synced Groups found.', 'civicrm-wp-profile-sync' ); ?></p>
		</div>
