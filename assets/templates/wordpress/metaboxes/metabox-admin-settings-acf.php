...
<table class="form-table">
	<tr>
		...
		<td>
			<p>
				<input type="checkbox" id="cwps_acf_integration_checkbox" name="cwps_acf_integration_checkbox" value="1"<?php checked( 1, $acf_enabled_checked ); ?>> <label for="cwps_acf_integration_checkbox"><?php esc_html_e( 'ACF Integration Enabled', 'civicrm-wp-profile-sync' ); ?></label>
			</p>
