...
<div class="form-field term-participant-role-active-wrap">
	<label for="cwps-participant-role-active"><?php esc_html_e( 'Enabled?', 'civicrm-wp-profile-sync' ); ?></label>
...
<div class="form-field term-participant-role-counted-wrap">
	<label for="cwps-participant-role-counted"><?php esc_html_e( 'Counted?', 'civicrm-wp-profile-sync' ); ?></label>
