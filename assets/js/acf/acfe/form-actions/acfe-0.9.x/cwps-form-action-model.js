...
(function($) {
	...
	var cwps_form_contact_action_ref = new acf.Model({
		...
		newContactActionRefField: function(field) {
			...
			contact_actions = acf.getFields({key:'field_cwps_contact_action_name'});
	...
	var cwps_form_case_action_ref = new acf.Model({
		...
		newCaseActionRefField: function(field) {
			...
			case_actions = acf.getFields({key:'field_cwps_case_action_name'});
	...
	var cwps_form_participant_action_ref = new acf.Model({
		...
		newParticipantActionRefField: function(field) {
			...
			participant_actions = acf.getFields({key:'field_cwps_participant_action_name'});
