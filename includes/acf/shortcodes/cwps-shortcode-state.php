<?php
/**
 * CiviCRM Profile Sync State Shortcode Class.
 *
 ...
 * @since 0.4
 */
class CiviCRM_Profile_Sync_ACF_Shortcode_State {
	...
	public function shortcode_render( $attr, $content = '', $tag = '' ) {
		...
		if ( is_feed() ) {
			return '<p>' . __( 'Visit the website to see the State.', 'civicrm-wp-profile-sync' ) . '</p>';
		}
	...
	public function shortcake_styles( $mce_css ) {
		...
		$mce_css .= ', ' . CIVICRM_WP_PROFILE_SYNC_PATH . 'assets/css/cwps-shortcode-state.css';
