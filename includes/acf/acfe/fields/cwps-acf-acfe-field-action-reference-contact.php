...
/**
 * ACFE Form "Contact Action Reference" Class.
 *
 * A class that encapsulates a "Contact Action Reference" Custom ACF Field in ACF 5+.
 *
 * @since 0.5
 */
class CiviCRM_Profile_Sync_ACF_ACFE_Form_Contact_Action_Ref extends acf_field {
	 ...
	 * @var string
	 */
	public $name = 'cwps_acfe_contact_action_ref';
	...
	public function __construct( $parent ) {
		...
		// Define label.
		$this->label = __( 'CiviCRM Form Action Reference: Contact', 'civicrm-wp-profile-sync' );
