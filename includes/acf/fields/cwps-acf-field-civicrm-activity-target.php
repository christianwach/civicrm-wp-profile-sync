<?php
/**
 * ACF "CiviCRM Activity Target Reference Field" Class.
 *
 * Provides a "CiviCRM Activity Target Reference Field" Custom ACF Field in ACF 5+.
 *
 ...
 * @since 0.4
 */
class CiviCRM_Profile_Sync_Custom_CiviCRM_Activity_Target extends acf_field {
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script(
			'acf-input-' . $this->name,
			plugins_url( 'assets/js/acf/fields/civicrm-activity-target-field.js', CIVICRM_WP_PROFILE_SYNC_FILE ),
			[ 'acf-input' ],
