<?php
/**
 * ACF "CiviCRM Activity Assignee Reference Field" Class.
 *
 * Provides a "CiviCRM Activity Assignee Reference Field" Custom ACF Field in ACF 5+.
 *
 ...
 * @since 0.4
 */
class CiviCRM_Profile_Sync_Custom_CiviCRM_Activity_Assignee extends acf_field {
	...
	public function __construct( $parent ) {
		...
		// Define label.
		$this->label = __( 'CiviCRM Activity: Assignee', 'civicrm-wp-profile-sync' );
	...
	public function input_admin_enqueue_scripts() {
		...
		wp_enqueue_script(
			'acf-input-' . $this->name,
			plugins_url( 'assets/js/acf/fields/civicrm-activity-assignee-field.js', CIVICRM_WP_PROFILE_SYNC_FILE ),
			[ 'acf-input' ],
