...
class CiviCRM_WP_Profile_Sync_Mapper {
	...
	public function setup_objects() {
		...
		// Initialise objects.
		$this->hooks = new CiviCRM_WP_Profile_Sync_Mapper_Hooks();
		$this->ufmatch = new CiviCRM_WP_Profile_Sync_Mapper_UFMatch();

		// Store references.
		$this->hooks->set_references( $this );
		$this->ufmatch->set_references( $this );
