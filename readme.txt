...
This plugin requires a minimum of *WordPress 3.9*, *BuddyPress 1.8* and *CiviCRM 4.6-alpha*. It also requires the [BP XProfile WordPress User Sync](http://wordpress.org/plugins/bp-xprofile-wp-user-sync/) plugin for syncing data with BuddyPress profiles. Please refer to the installation page for how to use this plugin with versions of CiviCRM prior to 4.6-alpha.
